...
struct Ball ball = {SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2, 5, 5};

struct Ball player_left = {5, SCREEN_HEIGHT / 2, 5, 50};

struct Ball player_right = {SCREEN_WIDTH - (5 * 2), SCREEN_HEIGHT / 2, 5, 50};
